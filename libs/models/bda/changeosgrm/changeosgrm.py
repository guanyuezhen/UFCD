...
class ChangeOSGRM(nn.Module):
    def __init__(self,
                 ...
                 num_bl_class: int = 1,
                 num_bda_class: int = 5):
        super(ChangeOSGRM, self).__init__()
        ...
        self.location_fpn = FeaturePyramidNetworks(self.in_channels, self.decoder_channel, self.num_grbs)
        self.damage_fpn = FeaturePyramidNetworks(self.in_channels, self.decoder_channel, self.num_grbs)
