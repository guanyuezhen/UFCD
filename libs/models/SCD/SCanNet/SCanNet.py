...
class SCanNet(nn.Module):
    def __init__(self,
        ...
        self.de_channel_c2 = de_channel_c2
        self.de_channel_c5 = de_channel_c5
        feat_size = image_size[0] // 4
        ...
        self.classifier1 = nn.Conv2d(de_channel_c5, num_scd_class, kernel_size=1)
        self.classifier2 = nn.Conv2d(de_channel_c5, num_scd_class, kernel_size=1)
        ...
        self.classifierCD = nn.Sequential(
            ...
            nn.ReLU(),
            nn.Conv2d(de_channel_c5 // 2, num_bcd_class, kernel_size=1)
        )
